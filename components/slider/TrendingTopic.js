                                    ...
                                    DataPortfolio.map((item, i) => (
                                        <SwiperSlide className="swiper-slide" key={i}>
                                            <div className="card-style-1">
                                                <Link href={`/portfolio-details2id/[id]`} as={`/portfolio-details2id/${item._id}`}>
                                                    <div className="card-image"><img style={{width:"300px" , height:"300px"}} src={`${Url + item.image}`} alt="Genz" />
                                                        <div className="card-info">
                                                            <div className="info-bottom">
                                                                <h6 className="color-white mb-5 w-25">{item.title}</h6>
                                                                <p className="text-xs color-gray-500">online</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </Link>
